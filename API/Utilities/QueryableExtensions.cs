...
internal static class QueryableExtensions
{
    ...
    internal static IQueryable<GostScore> AddFilters(this IQueryable<GostScore> queryable, SearchFilters? filters)
    {
        ...
        return queryable
            ...
            .Where(x => filters.Harmonization == null || x.Gost.Harmonization != null && filters.Harmonization.Contains(x.Gost.Harmonization.Value))
            .Where(x => filters.Status == null || x.Gost.Status != null && filters.Status.Contains(x.Gost.Status.Value))
            .Where(x => filters.AdoptionLevel == null || x.Gost.AdoptionLevel != null && filters.AdoptionLevel.Contains(x.Gost.AdoptionLevel.Value))
    ...
    internal static IQueryable<Gost> AddFilters(this IQueryable<Gost> queryable, SearchFilters? filters)
    {
        ...
        return queryable
            ...
            .Where(x => filters.Harmonization == null || x.Harmonization != null && filters.Harmonization.Contains(x.Harmonization.Value))
            .Where(x => filters.Status == null || x.Status != null && filters.Status.Contains(x.Status.Value))
            .Where(x => filters.AdoptionLevel == null || x.AdoptionLevel != null && filters.AdoptionLevel.Contains(x.AdoptionLevel.Value))
